...
from src.utils.analytics.row import (
    add_row_implementation,
    delete_rows_implementation,
    update_rows_implementation,
)
import traceback
...
@mcp.tool()
async def add_row(
    workspace_id: str, table_id: str, columns: dict[str, str], org_id: str | None = None
) -> dict:
    """
    <use_case>
...
async def delete_rows(
    workspace_id: str, table_id: str, criteria: str, org_id: str | None = None
):
    """
    <use_case>
