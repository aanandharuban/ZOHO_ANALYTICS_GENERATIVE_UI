...
class AnalyticsClient:
    ...
    class OrgAPI:
        ...
        def create_workspace(self, workspace_name, config={}):
            ...
            endpoint = "/restapi/v2/workspaces/"
            response = self.ac.send_api_request(
                "POST", endpoint, config, self.request_headers
            )
        ...
        def get_admins(self):
            ...
            response = self.ac.send_api_request(
                "GET", endpoint, None, self.request_headers
            )
        ...
        def get_meta_details(self, workspace_name, view_name):
            ...
            response = self.ac.send_api_request(
                "GET", endpoint, config, self.request_headers
            )
            return response["data"]
    ...
    class WorkspaceAPI:
        ...
        def rename(self, workspace_name, config={}):
            ...
            config["workspaceName"] = workspace_name
            response = self.ac.send_api_request(
                "PUT", self.endpoint, config, self.request_headers
            )
        ...
        def delete(self):
            ...
            """
            response = self.ac.send_api_request(
                "DELETE", self.endpoint, None, self.request_headers
            )
        ...
        def add_favorite(self):
            ...
            response = self.ac.send_api_request(
                "POST", endpoint, None, self.request_headers
            )
        ...
        def remove_favorite(self):
            ...
            endpoint = self.endpoint + "/favorite"
            response = self.ac.send_api_request(
                "DELETE", endpoint, None, self.request_headers
            )
        ...
        def create_variable(
            self, variable_name, variable_datatype, variable_type, config={}
        ):
            """
        ...
        def update_variable(
            ...
            config["variableType"] = variable_type
            response = self.ac.send_api_request(
                "PUT", endpoint, config, self.request_headers
            )
        ...
        def make_default_folder(self, folder_id):
            ...
            response = self.ac.send_api_request(
                "PUT", endpoint, None, self.request_headers
            )
        ...
        def export_as_template(self, view_ids, file_path, config={}):
            ...
            config["viewIds"] = view_ids
            self.ac.send_export_api_request(
        ...
        def get_aggregate_formula_dependents(self, formula_id):
            ...
            """
            endpoint = (
                self.endpoint + "/aggregateformulas/" + formula_id + "/dependents"
            )
            response = self.ac.send_api_request(
                "GET", endpoint, None, self.request_headers
            )
    ...
    class ViewAPI:
        ...
        def __init__(self, ac, org_id, workspace_id, view_id):
            self.ac = ac
            self.endpoint = (
                "/restapi/v2/workspaces/" + workspace_id + "/views/" + view_id
            )
            self.request_headers = {}
            self.request_headers["ZANALYTICS-ORGID"] = org_id
        ...
        def delete(self, config={}):
            ...
            """
            response = self.ac.send_api_request(
                "DELETE", self.endpoint, config, self.request_headers
            )
        ...
        def copy_formulas(
            self, formula_names, dest_workspace_id, config={}, dest_org_id=None
        ):
            """
        ...
        def delete_row(self, criteria, config={}):
            ...
            endpoint = self.endpoint + "/rows"
            response = self.ac.send_api_request(
                "DELETE", endpoint, config, self.request_headers
            )
    ...
    class BulkAPI:
        ...
        def import_data_in_new_table(
            self, table_name, file_type, auto_identify, file_path, config={}
        ):
            """
            ...
            response = self.ac.send_import_api_request(
                endpoint, config, self.request_headers, file_path
            )
            return response["data"]
        ...
        def import_data_in_new_table_as_batches(
            ...
            config["tableName"] = table_name
            config["autoIdentify"] = auto_identify
            response = self.ac.send_batch_import_api_request(
                endpoint,
                config,
                self.request_headers,
                file_path,
        ...
        def import_raw_data_in_new_table(
            self, table_name, file_type, auto_identify, data, config={}
        ):
            """
            ...
            config["autoIdentify"] = auto_identify
            response = self.ac.send_import_api_request(
                endpoint, config, self.request_headers, None, data
            )
            return response["data"]

        def import_data(
            self, view_id, import_type, file_type, auto_identify, file_path, config={}
        ):
            """
        ...
        def import_raw_data(
            self, view_id, import_type, file_type, auto_identify, data, config={}
        ):
            """
        ...
        def export_bulk_data(self, job_id, file_path):
            ...
            self.ac.send_export_api_request(
                endpoint, None, self.request_headers, file_path
            )
    ...
    def send_batch_import_api_request(
        self, request_url, config, request_headers, file_path, batch_size, tool_config
    ):
        ...
        for i in range(total_batch_count):
            batch = "".join(
                file_content[batch_size * i : batch_size + (i * batch_size)]
            )
            batch_file = StringIO(file_header + batch)
            files = {"FILE": batch_file}

            config["isLastBatch"] = (
                "true" if (i == (total_batch_count - 1)) else "false"
            )
    ...
    def send_import_api_request(
        self, request_url, config, request_headers, file_path, data=None
    ):
        """
        ...
        if bool(data):
            ...
            resp_obj = self.submit_import_request(
                request_url, config_data, request_headers, self.auth.get_access_token()
            )
        else:
    ...
    def submit_import_request(
        self, request_url, parameters, request_headers={}, access_token=None, files=None
    ):
        """
            ...
            if self.proxy:
                ...
                if self.proxy_user_name != None and self.proxy_password != None:
                    proxy_auth_details = HTTPProxyDigestAuth(
                        self.proxy_user_name, self.proxy_password
                    )
                    req_obj.auth = proxy_auth_details

            if bool(files):
                resp_obj = req_obj.post(
                    request_url, params=parameters, files=files, headers=request_headers
                )
            else:
                resp_obj = req_obj.post(
                    request_url, params=parameters, headers=request_headers
                )
    ...
    def send_export_api_request(self, request_url, config, request_headers, file_path):
        ...
        resp_obj = self.submit_export_request(
            request_url, config_data, request_headers, self.auth.get_access_token()
        )
    ...
    def submit_export_request(
        self, request_url, parameters, request_headers={}, access_token=None
    ):
        """
        Internal method to send request to server.
        """
    ...
    def submit_request(
        ...
        try:
            ...
            if request_method == "GET":
                ...
                resp_obj = req_obj.put(
                    request_url, params=parameters, headers=request_headers
                )
            elif request_method == "DELETE":
                resp_obj = req_obj.delete(
                    request_url, params=parameters, headers=request_headers
                )
    ...
    def regenerate_analytics_oauth_token(self):
        ...
        oauth_params = urllib.parse.urlencode(
            oauth_params
        )  # .encode(self.COMMON_ENCODE_CHAR)
...
class ServerError(Exception):
    ...
    def __init__(self, response, is_IAM_Error):
        ...
        try:
            ...
            if is_IAM_Error:
                self.message = (
                    "Exception while generating oauth token. Response - " + response
                )
            else:
...
class ParseError(Exception):
    ...
    def __init__(self, responseContent, message, origExcep):
        self.responseContent = (
            responseContent  #: The complete response content as sent by the server.
        )
